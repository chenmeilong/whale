...
def train(epo_num):
    ...
    for epo in range(epo_num):
        ...
        if np.mod(epo, 20) == 0:
            torch.save(fcn_model.state_dict(), 'checkpoints/fcn_model_{}.pkl'.format(epo))
            print('saveing checkpoints/fcn_model_{}.pkl'.format(epo))
        torch.save(fcn_model, 'model.pkl')
